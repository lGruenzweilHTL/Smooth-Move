...
public class ParkourMovement : MonoBehaviour
{
    ...
    public static ParkourMovement Instance { get; private set; }
    ...
    private void Movement()
    {
        ...
        {
            rb.AddForce(Time.deltaTime * 3000 * Vector3.down);
            return;
        }
    ...
    private void WallRunning()
    {
        ...
        if (isWallRunning)
        {
            rb.AddForce(Time.deltaTime * moveSpeed * -wallNormalVector);
            rb.AddForce(Time.deltaTime * rb.mass * wallRunGravity * -Physics.gravity.y * Vector3.up);
        }
    }
